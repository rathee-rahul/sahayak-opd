...
// Note: duplicate doctor entries are handled in doctor_data.json (one entry per doctor).
// mergeDuplicateDoctors removed — clean JSON is generated from Excel directly.
